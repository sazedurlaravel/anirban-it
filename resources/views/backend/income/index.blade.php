...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">আয়ের তালিকা</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">সকল আয়ের  হিসাব </h3>
          <a class="btn btn-success btn-sm float-right" href="{{route('income.add')}}">নতুন আয়  যোগ করুন </a>
